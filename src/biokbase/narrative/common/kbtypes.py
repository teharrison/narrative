...
class KBaseGenomes(object):
    ...
    class Pangenome(tls.Unicode, TypeMeta):
        ...
        class v3_0(tls.Unicode, TypeMeta):
            """Pangenome object: Pangenome object holds computed protein families,functions and genes for given set of genomes"""
    ...
    class GenomeComparison(tls.Unicode, TypeMeta):
        ...
        class v1_0(tls.Unicode, TypeMeta):
            """GenomeComparisonData object: GenomeComparisonData object holds computed protein families, functions for given set of genomes"""
